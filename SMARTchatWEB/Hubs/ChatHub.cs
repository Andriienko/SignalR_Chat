...
namespace SMARTchatWEB.Hubs
{
    public class ChatHub : Hub
    {
        ...
        public void RenameChannel(ChannelDTO channel)
        {
            ChannelService.RenameChannel(channel.ChannelId, channel);
            Clients.Group(channel.ChannelId).onChannelRename(channel);
        }

        public void RemoveChannel(ChannelDTO channel)
        {
            ChannelService.RemoveChannel(channel.ChannelId);
            Clients.Group(channel.ChannelId).onChannelRemove();
        }
